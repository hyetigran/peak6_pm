...
pub fn handler(
    ...
    if rec.schema_version == 0 {
        ...
        rec.oracle_program_id = fv.oracle_program_id;
        rec.oracle_programdata = fv.oracle_programdata;
        rec.oracle_deployment_slot = fv.oracle_deployment_slot;
        rec.oracle_executable_sha256 = fv.oracle_executable_sha256;
        rec.oracle_upgrade_authority = fv.oracle_upgrade_authority;
        rec.oracle_feed = fv.oracle_feed;
        rec.oracle_job_hash = fv.oracle_job_hash;
